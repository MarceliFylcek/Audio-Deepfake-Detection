...
def get_dataloader(dataset_path, batch_size, melspect_params, transform, augmentations, shuffle=True):
    ...
    dataset = FakeAudioDataset(real_folder, fake_folder, transform, augmentations=augmentations, **melspect_params)
